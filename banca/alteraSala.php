...
<html lang="pt-br">
    <head>
        ...
        <title>SISGBA | Alterar Sala</title>
        <!-- CSS -->
        ...
        <?php
            ...
            $computador = filter_input(INPUT_GET,"cpmutador");
    ...
    <div class="container" id="wrap">
	  <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form id="altera_sala" action="functionAlteraSala.php" method="GET" accept-charset="utf-8" class="form" role="form">
                    	...
                    	<div class="row">
                           <label class="col-md-12" for="recursos">Recursos: </label>
                            <div class="col-xs-6 col-md-12 input-lg">
                                <input type="checkbox" name="computador" value="on" checked=$computador/>
                                Computador
